    ...
    public partial class Admin_Register : Form
    {
        ...
        private void AdminRegister()
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("INSERT INTO AdminTable([AdminName],[AdminContacNo],[AdminEmail],[AdminAddress],[username],[password],[DOB],[Gender]) VALUES ('" + txt_FullName.Text + "','" + txt_PhoneNumber.Text + "','" + txt_Email.Text + "','" + txt_Address.Text + "','" + txt_UserName.Text + "','" + txt_Password.Text + "','" + dateTimePicker1.Text + "','" + Gender + "') ", con);
                cmd.ExecuteNonQuery();
        ...
        private void rbl_Female_CheckedChanged(object sender, EventArgs e)
        {
